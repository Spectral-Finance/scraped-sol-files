...
contract FraxUsdcCurveLpDualOracle is
    ...
    FraxUsdcUniswapV3SingleTwapOracle
{
    /// @notice The number of decimals on Frax Erc20
    uint8 public immutable FRAX_ERC20_DECIMALS;

    /// @notice The level of precision for the Frax Erc20
    uint256 public immutable FRAX_ERC20_PRECISION;

    /// @notice The number of decimals on Usdc Erc20
    uint8 public immutable USDC_ERC20_DECIMALS;

    /// @notice The level of precision for the Usdc Erc20
    uint256 public immutable USDC_ERC20_PRECISION;

    /// @notice The number of decimals on the Frax Usdc Curve Pool LP Erc20
    uint8 public immutable FRAX_USDC_CURVE_POOL_LP_ERC20_DECIMALS;

    /// @notice The level of precision for the Frax Usdc Curve Pool LP Erc20
    uint256 public immutable FRAX_USDC_CURVE_POOL_LP_ERC20_PRECISION;

    /// @notice The difference in precision between Frax and Usdc Erc20 tokens
    ...
    function name() external pure returns (string memory _name) {
        _name = "FraxUSDC Curve LP Dual Oracle w/ Min Max Bounds, Staleness Check";
    }
