...
abstract contract iTokenEIP2612DepositsTestTestBase is iTokenBaseSetUp {
...
contract iTokenEIP2612DepositsTest is iTokenEIP2612DepositsTestTestBase, RandomAddresses {
    ...
    function test_depositWithSignatureEIP2612_RevertWhenSharesDoNotMeetMinimumAmount() public {
        ...
        lendingIToken.depositWithSignatureEIP2612(DEFAULT_AMOUNT, alice, MINIMUM_AMOUNT_OUT + 1, deadline, signature);
    }
    ...
    function test_depositWithSignatureEIP2612() public {
        ...
        vm.prank(alice);
        lendingIToken.depositWithSignatureEIP2612(DEFAULT_AMOUNT, alice, MINIMUM_AMOUNT_OUT, deadline, signature);
    ...
    function test_mintWithSignatureEIP2612_RevertWhenMaxAssetsIsSurpassed() public {
        ...
        lendingIToken.mintWithSignatureEIP2612(DEFAULT_AMOUNT, alice, maximumAmountIn_, deadline, signature);
    }
    ...
    function test_mintWithSignatureEIP2612() public {
        ...
        uint256 underlyingBalanceBefore = underlying.balanceOf(alice);
        vm.prank(alice);
        lendingIToken.mintWithSignatureEIP2612(DEFAULT_AMOUNT, alice, DEFAULT_AMOUNT, deadline, signature);
    ...
    function test_liquidityCallback_RevertIfSenderIsNotLiquidityContract() public {
        ...
        lendingIToken.liquidityCallback(address(underlying), DEFAULT_AMOUNT, new bytes(0));
    }
    ...
    function test_liquidityCallback_RevertIfAssetIsInvalid() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Error.FluidLendingError.selector, ErrorTypes.iToken__Unauthorized));
        lendingIToken.liquidityCallback(invalidAsset, DEFAULT_AMOUNT, new bytes(0));
    }
    ...
    function test_liquidityCallback() public {
        ...
        vm.prank(alice);
        lendingIToken.depositWithSignatureEIP2612(DEFAULT_AMOUNT, alice, MINIMUM_AMOUNT_OUT, deadline, signature); // will reach callback
