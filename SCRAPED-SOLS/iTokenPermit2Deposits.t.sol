...
abstract contract iTokenPermit2DepositsTestBase is iTokenBaseSetUp {
...
contract iTokenPermit2DepositsTest is iTokenPermit2DepositsTestBase {
    ...
    function setUp() public virtual override {
        ...
        (, , , IAllowanceTransfer permit2, , , , , ) = lendingIToken.getData();
    ...
    function test_depositWithSignature() public {
        ...
        vm.prank(alice);
        uint256 shares = lendingIToken.depositWithSignature(defaultAmount, alice, 0, permit, signature);

        assertEqDecimal(shares, defaultAmount, DEFAULT_DECIMALS);
        assertEqDecimal(lendingIToken.balanceOf(alice), defaultAmount, DEFAULT_DECIMALS);
    ...
    function test_depositWithSignature_RevertIfMinAmountOut() public {
        ...
        lendingIToken.depositWithSignature(defaultAmount, alice, defaultAmount + 1, permit, signature);
    }
    ...
    function test_mintWithSignature() public {
        ...
        vm.prank(alice);
        uint256 shares = lendingIToken.mintWithSignature(defaultAmount, alice, defaultAmount, permit, signature);
    ...
    function test_mintWithSignature_RevertIfMaxAssetsIsSurpassed() public {
        ...
        lendingIToken.mintWithSignature(defaultAmount, alice, defaultAmount - 1, permit, signature);
    }
    ...
    function test_liquidityCallback_RevertIfSenderIsNotLiquidityContract() public {
        ...
        lendingIToken.liquidityCallback(address(underlying), 0, new bytes(0));
    }

    function test_liquidityCallback_RevertIfSenderIsNotAssetContract() public {
        vm.prank(address(liquidity));
        vm.expectRevert(abi.encodeWithSelector(Error.FluidLendingError.selector, ErrorTypes.iToken__Unauthorized));
        lendingIToken.liquidityCallback(address(0), 0, new bytes(0));
    }

    function test_liquidityCallback_RevertIfIsNotPermit2() public {
        ...
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(Error.FluidLendingError.selector, ErrorTypes.iToken__InvalidParams));
        lendingIToken.depositWithSignature(defaultAmount, alice, defaultAmount, permit, signature);
    }
...
contract iTokenPermit2DepositsEIP2612RevertsTest is iTokenPermit2DepositsTestBase {
    function test_depositWithSignatureEIP2612_Revert() public {
        ...
        vm.expectRevert();
        vm.prank(alice);
        lendingIToken.depositWithSignatureEIP2612(DEFAULT_AMOUNT, alice, 0, deadline, signature);
    }
    ...
    function test_mintWithSignatureEIP2612_Revert() public {
        ...
        vm.expectRevert();
        vm.prank(alice);
        lendingIToken.depositWithSignatureEIP2612(DEFAULT_AMOUNT, alice, DEFAULT_AMOUNT, deadline, signature);
    }
