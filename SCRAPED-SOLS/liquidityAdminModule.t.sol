...
import { AdminModule, AuthModule, GovernanceModule, GuardianModule, AuthInternals } from "../../../contracts/liquidity/adminModule/main.sol";
...
contract LiquidityAdminModuleGovernanceModuleTest is LiquidityAdminModuleBaseTest {
    function testAdminUpdateAuths() public {
        ...
        // execute
        vm.prank(admin);
        AdminModule(address(liquidity)).updateAuths(updateAuthsParams);
    ...
    function testAdminUpdateGuardians() public {
        ...
        // execute
        vm.prank(admin);
        AdminModule(address(liquidity)).updateGuardians(updateGuardiansParams);
    ...
    function testAdminUpdateRevenueCollector() public {
        ...
        // execute set alice
        vm.prank(admin);
        AdminModule(address(liquidity)).updateRevenueCollector(alice);
        ...
        // set bob
        vm.prank(admin);
        AdminModule(address(liquidity)).updateRevenueCollector(bob);
        // assert expected results
        revenueCollector = address(uint160(liquidity.readFromStorage(bytes32(0))));
...
contract LiquidityAdminModuleUpdateRateDataV1sTest is LiquidityAdminModuleBaseTest {
    ...
    function testAdminUpdateRateDataV1sOverflowKinkRevert() public {
        ...
        // execute
        vm.prank(admin);
        AdminModule(address(liquidity)).updateRateDataV1s(rateDataV1Params);
    }
    ...
    function testAdminUpdateRateDataV1sRateAtZeroBiggerRateAtKinkRevert() public {
...
contract LiquidityAdminModuleUpdateRateDataV2sTest is LiquidityAdminModuleBaseTest {
    ...
    function testAdminUpdateRateDataV2sOverflowKink1Revert() public {
        ...
        // execute
        vm.prank(admin);
        AdminModule(address(liquidity)).updateRateDataV2s(rateDataV2Params);
    }
    ...
    function testAdminUpdateRateDataV2sRateAtZeroBiggerRateAtKink1Revert() public {
    ...
    function testAdminUpdateRateDataV2sRateAtKink1BiggerRateAtKink2Revert() public {
...
contract LiquidityAdminModuleRevenueTest is LiquidityAdminModuleBaseTest {
    function setUp() public override {
        ...
        vm.prank(admin);
        AdminModule(address(liquidity)).updateRevenueCollector(admin);
    }
}
...
contract LiquidityAdminModuleCollectRevenueTest is LiquidityAdminModuleBaseTest {
    ...
    function test_AdminCollectRevenue() public {
        ...
        AdminModule(address(liquidity)).collectRevenue(tokens);
...
contract LiquidityAdminModuleUpdateUserClassesTest is LiquidityAdminModuleBaseTest {
    function test_AdminUpdateUserClasses() public {
        ...
        // execute
        vm.prank(admin);
        AdminModule(address(liquidity)).updateUserClasses(usersClass_);
...
contract LiquidityAdminModulePauseUserTest is LiquidityAdminModuleBaseTest {
    ...
    function test_GuardianPauseUser() public {
        ...
        vm.prank(alice);
        AdminModule(address(liquidity)).pauseUser(address(DAI), tokens_, tokens_);
    ...
    function test_GuardianPauseUser_RevertUserNotDefined() public {
        ...
        vm.prank(alice);
        AdminModule(address(liquidity)).pauseUser(address(resolver), noTokens_, tokens_);
        ...
        vm.prank(alice);
        AdminModule(address(liquidity)).pauseUser(address(resolver), tokens_, noTokens_);
    }
    ...
    function test_GuardianUnpauseUser() public {
        ...
        vm.prank(alice);
        AdminModule(address(liquidity)).unpauseUser(address(DAI), tokens_, tokens_);
