...
//         vm.prank(alice);
//         // execute supplySafe
//         UserModule(address(liquidity)).supplySafe(address(USDC), DEFAULT_SUPPLY_AMOUNT, alice);

//         // 2. borrow as bob
//         // prank msg.sender to be bob
//         vm.prank(bob);
//         // execute borrow
//         UserModule(address(liquidity)).borrow(address(USDC), DEFAULT_BORROW_AMOUNT, bob);
...
//         vm.prank(alice);
//         // execute supplyRisky
//         UserModule(address(liquidity)).supplyRisky(address(USDC), DEFAULT_SUPPLY_AMOUNT, alice);
...
//         vm.prank(alice);
//         UserModule(address(liquidity)).withdrawSafe(address(USDC), DEFAULT_WITHDRAW_AMOUNT, alice);
...
//         // 6. withdraw some amount
//         vm.prank(alice);
//         UserModule(address(liquidity)).withdrawRisky(address(USDC), DEFAULT_WITHDRAW_AMOUNT, alice);
...
//         UserModule(address(liquidity)).supplySafe(address(USDC), DEFAULT_SUPPLY_AMOUNT / 2, alice);
//         // DAI
//         // prank msg.sender to be alice
//         vm.prank(alice);
//         // execute supplySafe, only half amount to have same utilization as in other test
...
//         UserModule(address(liquidity)).supplyRisky(address(USDC), DEFAULT_SUPPLY_AMOUNT / 2, alice);
