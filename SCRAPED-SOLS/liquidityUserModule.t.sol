...
//         vm.prank(alice);
//         // execute supplySafe
//         UserModule(address(liquidity)).operate(
//             address(USDC),
//             DEFAULT_SUPPLY_AMOUNT,
//             0,
//             address(0),
...
//         vm.prank(bob);
//         // execute borrow
//         UserModule(address(liquidity)).operate(address(USDC), 0, DEFAULT_BORROW_AMOUNT, address(0), bob, new bytes(0));
...
//         UserModule(address(liquidity)).operate(address(USDC), 0, borrowAmount, address(0), bob, new bytes(0));
...
//         vm.prank(alice);
//         (uint256 checkSupplySafeExchangePrice_, uint256 checkBorrowExchangePrice_) = UserModule(address(liquidity))
...
//         // 3. execute pause
//         vm.prank(admin);
//         AdminModule(address(liquidity)).changeStatus(1);
...
//         vm.prank(bob);
//         UserModule(address(liquidity)).operate(address(USDC), 0, DEFAULT_PAYBACK_AMOUNT, address(0), bob, new bytes(0));
//         vm.prank(alice);
//         UserModule(address(liquidity)).operate(address(USDC), DEFAULT_WITHDRAW_AMOUNT, 0, alice, address(0), new bytes(0));
//         vm.prank(alice);
//         UserModule(address(liquidity)).operate(address(USDC), DEFAULT_WITHDRAW_AMOUNT, 0, alice, address(0), new bytes(0));
...
//         vm.prank(alice);
//         UserModule(address(liquidity)).operate(address(USDC), DEFAULT_SUPPLY_AMOUNT, 0, address(0), address(0), new bytes(0));
//         vm.expectRevert(UserModuleHelpers.UserModulePaused.selector);
//         vm.prank(alice);
//         UserModule(address(liquidity)).operate(address(USDC), DEFAULT_SUPPLY_AMOUNT / 2, 0, address(0), address(0), new bytes(0));
//         vm.expectRevert(UserModuleHelpers.UserModulePaused.selector);
//         vm.prank(bob);
//          UserModule(address(liquidity)).operate(address(USDC), 0, DEFAULT_BORROW_AMOUNT, address(0), bob, new bytes(0));
//         // batch
...
//         // vm.expectRevert(UserModuleHelpers.UserModulePaused.selector);
//         // vm.prank(alice);
//         // UserModule(address(liquidity)).batch(actions);

//         // 5. execute unpause
//         vm.prank(admin);
//         AdminModule(address(liquidity)).changeStatus(0);
...
//         ) = UserModule(address(liquidity)).updateExchangePrices(tokens_);
...
//         vm.prank(alice);
//         // execute supplySafe, only half amount to have same utilization as in other test
//         UserModule(address(liquidity)).supplySafe(address(DAI), DEFAULT_SUPPLY_AMOUNT, alice);
...
//         vm.prank(bob);
//         // execute borrow
//         UserModule(address(liquidity)).borrow(address(DAI), DEFAULT_BORROW_AMOUNT, bob);
...
//         vm.prank(bob);
//         // execute borrow, borrow 90% of supplied amount
//         UserModule(address(liquidity)).borrow(address(USDC), borrowAmount, bob);
...
//         vm.prank(alice);
//         UserModule(address(liquidity)).supplySafe(address(USDC), DEFAULT_MAX_DEBT_CEILING * 10, alice);
//     }
...
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), debtCeilingBaseDefault, bob);
//     }
...
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), debtCeilingBaseDefault + 1, bob);
//     }
...
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), 4.9 ether, bob);
...
//         vm.expectRevert(CoreInternals.UserModuleAboveBorrowLimit.selector);
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), borrowLimit - currentBorrow + 1, bob);
//         // borrow as bob to current debt ceiling
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), borrowLimit - currentBorrow, bob);
...
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), 5.3 ether - currentBorrow, bob);
...
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), baseDebtCeiling, bob);
...
//         vm.expectRevert(CoreInternals.UserModuleAboveBorrowLimit.selector);
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), maxDebtCeiling - currentBorrow + 1, bob);
//         // borrow as bob
//         vm.prank(bob);
//         UserModule(address(liquidity)).borrow(address(USDC), maxDebtCeiling - currentBorrow, bob);
//     }
...
//         (, , uint256 currentBorrow) = ReadModule(address(liquidity)).balancesOf(address(USDC), bob);
//         vm.prank(bob);
//         UserModule(address(liquidity)).repay(address(USDC), currentBorrow - 2 ether, bob);
...
//         (, , uint256 currentBorrow) = ReadModule(address(liquidity)).balancesOf(address(USDC), bob);
//         vm.prank(bob);
//         UserModule(address(liquidity)).repay(address(USDC), currentBorrow - 4 ether, bob);
...
//         // we must use current borrow amount which is adjusted for exchange price
//         vm.prank(bob);
//         UserModule(address(liquidity)).repay(address(USDC), currentBorrow - 3 ether, bob);
...
//         // we must use current borrow amount which is adjusted for exchange price
//         vm.prank(bob);
//         UserModule(address(liquidity)).repay(address(USDC), currentBorrow - 1 ether, bob);
...
//         // // 5. repay as bob to 0
//         // vm.prank(bob);
//         // UserModule(address(liquidity)).repay(
//         //     address(USDC),
...
//         // vm.prank(alice);
//         // UserModule(address(liquidity)).withdrawSafe(
//         //     address(USDC),
//         //     (DEFAULT_SUPPLY_AMOUNT * newSupplySafeExchangePrice) / EXCHANGE_PRICES_PRECISION,
//         //     alice
//         // );
